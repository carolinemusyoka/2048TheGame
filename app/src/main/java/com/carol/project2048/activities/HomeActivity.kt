...
import com.carol.project2048.utils.*
import com.carol.project2048.utils.StateHandler.continuingGame
import com.carol.project2048.utils.StateHandler.currentState
import com.carol.project2048.utils.StateHandler.grid
import com.carol.project2048.utils.StateHandler.moveCount
import com.carol.project2048.utils.StateHandler.over
import com.carol.project2048.utils.StateHandler.previousState
import com.carol.project2048.utils.StateHandler.updateState
import com.carol.project2048.utils.StateHandler.updateToMatchState
import com.carol.project2048.utils.StateHandler.won
import com.carol.project2048.utils.TimerHandler.startTimer
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun createTileTextView(value: Int): TextView {
        ...
        with(tile) {
            ...
            if (value <= 2048) {
                val colorId = ContextCompat.getColor(this@HomeActivity, resources.getIdentifier("tile$value", "color", packageName))
                background.mutate().setTint(colorId)
            } else {
                background.mutate().setTint(ContextCompat.getColor(this@HomeActivity, R.color.tileSuper))
            }
